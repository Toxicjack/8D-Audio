...
def main():
    ...
    if args.save:
        ...
        save_processed_audio(args.file, args.save, pan_speed=args.pan_speed, reverb_amount=args.reverb_amount, eq_gains=args.eq_gains, volume=args.volume)
        print(f"Saved processed audio to {args.save}")
    else:
        print(f"Playing {args.file} with 8D effects...")
        play_processed_audio(args.file, pan_speed=args.pan_speed, reverb_amount=args.reverb_amount, eq_gains=args.eq_gains, volume=args.volume)
